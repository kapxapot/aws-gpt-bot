...
В начале использования бота вам доступен тариф <b>«Бесплатный»</b> с ограничением до ${getPlanSettingsLimitText(getPlanSettings("free"), "gpt3", "day")} запросов в день.
