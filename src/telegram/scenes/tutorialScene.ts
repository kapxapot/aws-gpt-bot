...
Если вам необходимо большее количество запросов к <b>${gptDefaultModelName}</b> или доступ к <b>${gptPremiumModelName}</b> и <b>DALL-E</b> — приобретите один из пакетов услуг (пункт меню «Пакеты услуг» ${formatCommand(commands.premium)}).`,
...
Выбирайте один из режимов ${formatCommand(commands.mode)} или начните писать боту прямо сейчас!
👇`
];
